...
const FormularzPlatnosci: NextPage = () => {
  ...
  // 2. Pobieramy dane użytkownika z API (obsługuje format bezpośredni oraz z .data)
  useEffect(() => {
  ...
  // 3. Funkcja obsługująca wpisywanie danych do inputów i textarea
    ...
    <div className={styles.produktyWKoszyku}>
      <div className={styles.frameParent}>
        ...
        <div className={styles.frameParent6}>
          ...
          {/* Zamienione na funkcyjne textarea, które przekazuje tekst do formData.notes */}
